    ...
    private Player updateFreeThrowShooterStats(Matchup matchup, Play play, LabeledPlay lPlayOne) {
        ...
        if (playerOne != null && playerOne.getId() != 0) {
            ...
            if (lPlayOne.isShotMade()) {
                if (!lPlayOne.getText().equalsIgnoreCase("free throw 2 of 2")  && !lPlayOne.getText().equalsIgnoreCase("free throw 1 of 1") && !lPlayOne.getText().equalsIgnoreCase("free throw 3 of 3")/*Niche Case */){
